...
export default function page() {
  ...
  const handleLogin = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    await postData(url + "/api/auth/login", loginRequest, header);
    // dang nhap xong phai xu li check remember va authenticate va chuyen huong trang
  }
  return (
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              />
              <Button onClick={() => setVisible(!isVisible)} size="icon" className='h-9 absolute inset-y-0 right-0 flex items-center px-3 bg-transparent text-gray-400 hover:text-gray-500 focus:outline-none'>
